...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col w-full md:max-w-md md:mx-auto bg-background/50 relative overflow-hidden md:shadow-2xl">
      <main className="flex-1 overflow-y-auto pb-24 px-6 pt-8 scrollbar-hide">
        {children}
      </main>

      <nav className="fixed bottom-0 left-0 right-0 md:max-w-md md:mx-auto bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-t border-border z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
